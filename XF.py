    ...
    if files is not None:
        ...
        try:
            ...
            with col12:
                ...
                output = st_echarts(option,height=600,events=events)
            ...
            if output is not None:
                ...
                if output == "Top-A":
                    st.markdown('<p style="text-align: center;color: #0082B4;font-size:35px">GEIL!</p>', unsafe_allow_html=True)

                if output == "Top-B":
                    st.markdown('<p style="text-align: center;color: #0082B4;font-size:35px">FOST GEIL!</p>', unsafe_allow_html=True)

                if output == "Top-C":
                    st.markdown('<p style="text-align: center;color: #0082B4;font-size:35px">NAJO!</p>', unsafe_allow_html=True)
                ...
                if output == "Medium-C":
                    st.markdown('<p style="text-align: center;color: #0082B4;font-size:35px">BESCHISSEN!</p>', unsafe_allow_html=True)
                ...
                if output == "Low-C":
                    st.markdown('<p style="text-align: center;color: #0082B4;font-size:35px">RICHTIG BESCHISSEN!</p>', unsafe_allow_html=True)
